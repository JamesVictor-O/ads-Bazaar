...
import { CheckCircle, Clock, Globe, X, AlertTriangle } from "lucide-react";
...
export const SubmissionsModal = ({
  ...
  const [selectedInfluencer, setSelectedInfluencer] = useState<Hex | null>(null);
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex justify-between items-start gap-3">
                      ...
                      {submission.isFlagged ? (
                        <span className="px-3 py-1 text-xs rounded-full bg-red-500/10 text-red-400 border border-red-500/20 flex items-center flex-shrink-0">
                    ...
                    <div className="text-sm text-slate-300">
                      {submission.proofLink ? (
                        <div className="flex flex-col space-y-3">
                          ...
                          {!submission.isApproved && !submission.isFlagged && (
                            <div className="pt-2 sm:mt-3 flex justify-end gap-2">
                              <button
                              ...
                              <button
                                onClick={() => handleOpenDisputeModal(submission.influencer)}
                                disabled={isCompletingCampaign}
                                className="px-4 py-2 text-sm font-medium text-red-400 bg-red-500/10 border border-red-500/20 rounded-xl hover:bg-red-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center"
                              >
