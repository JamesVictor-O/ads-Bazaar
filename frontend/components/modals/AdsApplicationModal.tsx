...
export default function ApplyModal({
  ...
  const handleApply = async (): Promise<void> => {
    ...
    console.log("selected brief", selectedBrief)
  ...
  <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-sm flex items-center justify-center p-4 z-50 transition-opacity duration-300">
    <div className="bg-slate-800/80 backdrop-blur-xl border border-slate-700/50 rounded-2xl w-full max-w-2xl mx-auto max-h-[85vh] overflow-hidden flex flex-col shadow-2xl shadow-emerald-500/10">
      ...
      <div className="overflow-y-auto flex-1">
        <div className="p-8">
          ...
          <div className="bg-slate-900/50 border border-slate-700/50 rounded-xl p-6 mb-6 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                <div className="w-10 h-10 bg-blue-500/10 rounded-full flex items-center justify-center border border-blue-500/20 mt-1">
              ...
              {selectedBrief.requirements && (
                <div className="flex items-start space-x-3">
                  <div className="w-10 h-10 bg-orange-500/10 rounded-full flex items-center justify-center border border-orange-500/20 mt-1">
          ...
          {/* Loading State */}
          {isPending && (
            <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-start">
