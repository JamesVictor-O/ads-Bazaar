-- Database tables required for AdsBazaar notifications
...
CREATE TRIGGER update_user_fid_mappings_updated_at BEFORE UPDATE ON user_fid_mappings FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_dispute_resolvers_updated_at BEFORE UPDATE ON dispute_resolvers FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();